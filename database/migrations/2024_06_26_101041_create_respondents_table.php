...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('respondents', function (Blueprint $table) {
            ...
            $table->string('respondent_place_of_birth')->nullable();
            ...
            $table->string('respondent_village')->nullable();
            ...
            $table->string('respondent_work_street')->nullable();
            $table->string('respondent_work_village')->nullable();
