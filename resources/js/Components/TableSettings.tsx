      ...
      <table className="table">
        <thead>
          <tr className="bg-gray-2 text-left dark:bg-meta-4">
            <th className="min-w-[220px] py-4 px-4 font-medium text-black dark:text-claude-text xl:pl-11">Bond</th>
            <th className="min-w-[150px] py-4 px-4 font-medium text-black dark:text-claude-text">Paramter</th>
            <th className="py-4 px-4 font-medium text-black dark:text-claude-text">Criterion</th>
            <th className="py-4 px-4 font-medium text-black dark:text-claude-text">Value to give alert</th>
            <th className="py-4 px-4 font-medium text-black dark:text-claude-text">Alert type</th>
            <th className="py-4 px-4 font-medium text-black dark:text-claude-text">Actions</th>
          </tr>
        </thead>
        <tbody>
