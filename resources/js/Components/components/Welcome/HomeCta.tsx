    ...
    return (
        <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            ...
            <div className="space-y-2 flex flex-col">
                ...
                <button className="text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800 shadow  border border-solid border-slate-300"
