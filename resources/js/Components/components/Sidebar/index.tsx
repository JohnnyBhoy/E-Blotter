...
import { Book, BoxArrowLeft, BoxArrowRight, ChevronDown, Gear, Grid, List, Map, Person, PersonArmsUp, X } from 'react-bootstrap-icons';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen ${isCollapse ? 'w-17' : 'w-58'} flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ml-[-2rem] ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
        ...
        <Link href="/dashboard" className='flex gap-2'>
          ${isCollapse
            ...
            : <><img src={Logo} alt="Logo" className='h-10 w-10' />
              <h3 className={`font-bold text-3xl text-white  'hidden' : ''}`}>E-Blotter</h3>
            </>}
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-hidden duration-300 ease-linear">
        ...
        <nav className="py-4 px-4 lg:px-6">
          ...
          <div>
            ...
            {isCollapse
              ? <List
                ...
                className='text-white ml-3 mt-[1rem]'
                size={24}
              />
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                {isCollapse
                  ? <Grid size={16} className="text-white mt-6 ml-4" />
                  :
                  <Link
                    href="/dashboard"
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="1em" height="1em" fill="currentColor" className="bi bi-grid">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/blotter' || pathname.includes('blotter')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      {isCollapse
                        ? <Book size={16} className="text-white mt-6 ml-4" />
                        : <Link
                          href="#"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/blotter' ||
                            pathname.includes('blotter')) &&
          ...
          {/* <!-- Others Group --> */}
          <div>
            <h3 className={`mb-4 ml-4 text-sm font-semibold text-bodydark2 ${isCollapse ? 'hidden' : ''}`}>
              OTHERS
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                {isCollapse
                  ? <svg
                    className="fill-current text-white ml-4 mt-[3.5rem]"
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                    fill="none"
              ...
              <li>
                {isCollapse
                  ? <PersonArmsUp className='text-white ml-4 mt-[1.5rem]' />
                  :
                  <Link
                    href="/officials"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('officials') && 'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <PersonArmsUp />
                    Officials
              ...
              <li>
                {isCollapse
                  ? <Map className='text-white ml-4 mt-[1.5rem]' />
                  : <Link
                    href="/map"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                {isCollapse
                  ? <Gear className='text-white ml-4 mt-[3.7rem]' />
                  : <Link
                    href="/settings"
              ...
              <li>
                {isCollapse
                  ? <BoxArrowRight className='text-white ml-4 mt-[1.5rem]' />
                  : <button
