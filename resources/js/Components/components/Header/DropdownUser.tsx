          ...
          <div className="p-10">
            ...
            <div className="flex justify-between gap-10 pt-10">
              ...
              <Link
                ...
                method='post'
                as="button"
                className="inline-flex items-center justify-center rounded-md bg-primary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10 w-full">
                {!isLoading
                  ? 'Confirm'
