                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    >
                        <div className="relative w-5 h-5 flex flex-col justify-center items-center">
                            <span
                                className={`block h-0.5 w-5 rounded-full bg-white transition-all duration-300 ${props.sidebarOpen ? "rotate-45 translate-y-1.5" : ""}`}
                            ></span>
                            <span
                                className={`block h-0.5 w-5 rounded-full bg-white transition-all duration-300 my-1 ${props.sidebarOpen ? "opacity-0" : ""}`}
                            ></span>
                            <span
                                className={`block h-0.5 w-5 rounded-full bg-white transition-all duration-300 ${props.sidebarOpen ? "-rotate-45 -translate-y-1.5" : ""}`}
                            ></span>
