    ...
    return (
        < div className="" >
            <header className="fixed w-full shadow">
                <nav className="bg-white border-gray-200 py-2.5 dark:bg-claude-bg">
                    <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                        <Link href="/" className="flex items-center">
                            <img src="/images/logs.ico" className="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-claude-text text-blue-500">E-911</span>
                        </Link>
                        <div className="flex items-center lg:order-2 hidden">
                            ...
                            <button data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-claude-text-muted dark:hover:bg-claude-panel-2 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
                        ...
                        <div className="items-center justify-between w-full lg:flex lg:w-auto lg:order-1 hidden" id="mobile-menu-2">
                            ...
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 hidden">
                                <li>
                                    <Link
                                        href="/"
                                        className="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded lg:bg-transparent lg:text-purple-700 lg:p-0 dark:text-claude-text" aria-current="page">
                                        Overview
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                        href="/faq"
                                        className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-claude-text-muted lg:dark:hover:text-white dark:hover:bg-claude-panel-2 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-claude-border">
                                        FAQ
                                    </Link>
                                </li>
                                <li>
