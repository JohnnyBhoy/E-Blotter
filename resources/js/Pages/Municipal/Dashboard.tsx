...
export default function Dashboard({ auth, datas, lastYearBlotter, thisYearBlotter, thisWeekBlotter, blotterPerYear, monthlyIncidents, topBarangay }
    : PageProps<{
        datas: number[];
        lastYearBlotter: any;
        thisYearBlotter: any;
