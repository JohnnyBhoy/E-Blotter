            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 transition-all duration-500">
                ...
                <div className="relative z-10 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/20 dark:from-blue-500/20 dark:to-blue-600/30 backdrop-blur-xl rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                        ...
                        <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/20 dark:from-amber-500/20 dark:to-amber-600/30 backdrop-blur-xl rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-gradient-to-br from-emerald-500/10 to-emerald-600/20 dark:from-emerald-500/20 dark:to-emerald-600/30 backdrop-blur-xl rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/20 dark:from-purple-500/20 dark:to-purple-600/30 backdrop-blur-xl rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                            <div className="flex items-center justify-between">
                                <div>
                    ...
                    <div className="bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 mb-6 border-0">
                                ...
                                <button
                                    ...
                                    className={`flex-1 min-w-fit px-4 py-2 rounded-xl font-medium transition-all duration-300 ${
                                        activeTab === tab.id
                                            ...
                                            : "text-gray-600 dark:text-gray-300 hover:bg-gradient-to-r hover:from-blue-100 hover:to-blue-200 dark:hover:from-white/10 dark:hover:to-white/20 hover:text-blue-600 dark:hover:text-blue-300"
                                    }`}
                                >
                        ...
                        {activeTab === "overview" && (
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-gradient-to-br from-blue-50/50 to-blue-100/30 dark:from-blue-500/10 dark:to-blue-600/20 rounded-xl p-4 border-0">
                                        ...
                                        <div className="space-y-2">
                                            {blotters
                                                ...
                                                ?.map((blotter) => (
                                                    <div
                                                        key={blotter.id}
                                                        className="flex items-center justify-between p-3 bg-white/50 dark:bg-white/10 rounded-xl hover:bg-white/70 dark:hover:bg-white/20 transition-all duration-200 border-0"
                                                    >
                                                        <div className="flex items-center space-x-2">
                                                            <MapPin className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                                                            <span className="text-sm text-gray-900 dark:text-blue-200">
                                                                {getIncidentType(
                                                                    blotter.incident_type,
                                                                )}
                                                            </span>
                                                        </div>
                                                        <span className="text-xs text-gray-600 dark:text-blue-300">
                                                            {new Date(
                                                                blotter.created_at,
                                                            ).toLocaleDateString()}
                                                        </span>
                                    ...
                                    <div className="bg-gradient-to-br from-emerald-50/50 to-emerald-100/30 dark:from-emerald-500/10 dark:to-emerald-600/20 rounded-xl p-4 border-0">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 border-0"
                                            >
                            ...
                            <div>
                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm font-medium text-blue-600 dark:text-blue-200 mb-2">
                                                Date Reported
                                            </label>
                                            <input
                                                type="date"
                                    ...
                                    <table className="w-full text-black dark:text-white">
                                        <thead>
                                            <tr className="border-b border-blue-200 dark:border-white/20">
                                                <th className="text-left p-3 font-semibold text-blue-800 dark:text-white">
                                                    Entry #
                                                </th>
                                                <th className="text-left p-3 font-semibold text-blue-800 dark:text-white">
                                                    Incident Type
                                        ...
                                        <tbody>
                                            {filteredBlotters.map((blotter) => (
                                                <tr
                                                    key={blotter.id}
                                                    className="border-b border-blue-100 dark:border-white/10 hover:bg-blue-50 dark:hover:bg-white/5"
                                                >
                                                    <td className="p-3">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {blotters.map((blotter) => (
                                        <div
                                            key={blotter.id}
                                            className="bg-blue-50 dark:bg-white/5 rounded-lg p-4 border border-blue-200 dark:border-white/10"
                                        >
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-sm text-gray-600 dark:text-blue-300 line-clamp-2">
                                                    {blotter.narrative}
                                                </p>
                                            </div>
